...
mod tests {
        ...
        fn test_layout_libpostal_address_parser_options() {
                ...
                assert_eq!(
                        unsafe {
                                &(*(::std::ptr::null::<libpostal_address_parser_options>()))
                                        .language as *const _
                                        as usize
                        },
                        0usize,
