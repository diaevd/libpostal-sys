...
extern "C" {
    ...
    pub fn libpostal_expand_address(
        input: *const c_char, options: libpostal_normalize_options, n: *mut usize,
    ) -> *const *const c_char;
    ...
    pub fn libpostal_parse_address(
        address: *const c_char, options: libpostal_address_parser_options,
...
mod tests {
    ...
    fn test_layout_libpostal_normalize_options() {
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<libpostal_normalize_options>())).languages as *const _
                    as usize
            },
            0usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<libpostal_normalize_options>())).latin_ascii as *const _
                    as usize
            },
            18usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<libpostal_normalize_options>())).decompose as *const _
                    as usize
            },
            21usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<libpostal_normalize_options>())).lowercase as *const _
                    as usize
            },
            22usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<libpostal_normalize_options>())).trim_string as *const _
                    as usize
            },
            23usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<libpostal_normalize_options>())).replace_word_hyphens
                    as *const _ as usize
            },
            28usize,
            concat!(
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<libpostal_normalize_options>())).delete_final_periods
                    as *const _ as usize
            },
            30usize,
            concat!(
    ...
    fn test_layout_libpostal_address_parser_response() {
        ...
        assert_eq!(
            unsafe {
                &(*(::std::ptr::null::<libpostal_address_parser_response>())).num_components
                    as *const _ as usize
            },
            0usize,
            concat!(
